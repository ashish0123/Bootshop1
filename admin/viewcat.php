	     ...
	     <form class="myform">
		   <table class="tbl">
				...
				<tr>
                   ...
                   <td>
				   <a href="editcat.php?catid=<?php echo $result['catId']; ?>">Edit</a> ||
				   <a onclick="return confirm('Are you sure want to delete this?')" href="?delcat=<?php echo $result['catId']; ?>">Delete</a></td>
				</tr>
				<?php }} ?>
